...
class FacebookPixel
{
    ...
    {
        $this->enabled = core()->getConfigData('custom.setting.facebook-pixel.enable') ?? 0;
        $this->pixelId = core()->getConfigData('custom.setting.facebook-pixel.id') ?? '';
        $this->token = core()->getConfigData('custom.setting.facebook-pixel.token') ?? '';
